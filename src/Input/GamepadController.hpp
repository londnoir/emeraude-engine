/*
 * Emeraude/Input/GamepadController.hpp
...
namespace Emeraude::Input
{
	...
	class GamepadController final : public ControllerInterface
	{
		public:
			 ...
			 * @param ID deviceID ID. Default -1.
			 */
			explicit GamepadController (int deviceID = -1) noexcept;
			 ...
			 */
			[[nodiscard]]
			float axeValue (GamepadAxis axe) const noexcept;
		...
		private:
			...
			static std::array< GLFWgamepadstate, 16 > s_devicesState; // NOLINT NOTE: Special state copy.
