/*
 * Emeraude/Saphir/Declaration/InputPrimitive.cpp
...
namespace Emeraude::Saphir::Declaration
{
	...
	InputPrimitive::InputPrimitive (Key primitiveType) noexcept
		: m_name(primitiveType)
	{
	...
	{
		return (std::stringstream{} << GLSL::Layout << " (" << m_name << ") " << GLSL::In << ";" "\n").str();
	}
}
