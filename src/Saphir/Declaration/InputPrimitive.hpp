/*
 * Emeraude/Saphir/Declaration/InputPrimitive.hpp
...
namespace Emeraude::Saphir::Declaration
{
	...
	class InputPrimitive final : public Interface
	{
		public:
			 ...
			 * @param primitiveType A C-string to set the GLSL type of the primitive. Use one of Keys::GLSL::Geometry::In::Primitive::* keyword.
			 */
			explicit InputPrimitive (Key primitiveType) noexcept;
