/*
 * Emeraude/Graphics/Renderable/AbstractSeaLevel.hpp
...
namespace Emeraude::Graphics::Renderable
{
	...
	class AbstractSeaLevel : public Interface
	{
		...
		protected:
			 ...
			 */
			explicit AbstractSeaLevel (const std::string & name, uint32_t resourceFlagBits) noexcept;

			/**
			 * @brief Destructs the renderable sea level.
			 */
			~AbstractSeaLevel () override = default;
