/*
 * Emeraude/Graphics/Material/Component/Specular.hpp
...
namespace Emeraude::Graphics::Material::Component
{
	...
	>
	class Specular final : public Interface
	{
		public:
			 ...
			 * @param shininess The initial shininess value. Default 32.0.
			 */
			explicit Specular (const component_t & component, float shininess = 32.0F) noexcept
				: m_component(component), m_shininess(shininess)
			{
			...
			/**
			 * @brief Sets the shininess parameter for the specular component.
			 * @param value The shininess intensity.
			 * @return void
			 */
			void
			setShininess (float value) noexcept
			{
				m_shininess = value;
			}

			/**
			 * @brief Returns the shininess parameter.
			 * @return float
			 */
			[[nodiscard]]
			float
