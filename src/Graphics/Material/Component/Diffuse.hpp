/*
 * Emeraude/Graphics/Material/Component/Diffuse.hpp
...
namespace Emeraude::Graphics::Material::Component
{
	...
	>
	class Diffuse final : public Interface
	{
		public:
			 ...
			 */
			explicit Diffuse (const component_t & component) noexcept
