/*
 * Emeraude/Graphics/Material/Component/Metalness.hpp
...
namespace Emeraude::Graphics::Material::Component
{
	...
	>
	class Metalness final : public Interface
	{
		public:
			 ...
			 */
			explicit Metalness (const component_t & component) noexcept
