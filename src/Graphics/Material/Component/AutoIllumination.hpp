/*
 * Emeraude/Graphics/Material/Component/AutoIllumination.hpp
...
{
	/**
	 * @brief The auto-illumination component.
	...
	>
	class AutoIllumination final : public Interface
	{
		public:
			 ...
			 */
			explicit AutoIllumination (const component_t & component, auto amount = 1.0F) noexcept
			...
			/**
			 * @brief Sets the global control value for auto-illumination.
			...
			/**
			 * @brief Returns the global control value for auto-illumination.
			 * @return float
			 */
			[[nodiscard]]
			float
