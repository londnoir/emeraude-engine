/*
 * Emeraude/Graphics/Material/Component/Reflection.hpp
...
namespace Emeraude::Graphics::Material::Component
{
	...
	>
	class Reflection final : public Interface
	{
		public:
			 ...
			 * @param amount A value between 0.0 and 1.0. Default 50%.
			 */
			explicit Reflection (const component_t & component, auto amount = 0.5F) noexcept
			...
			/**
			 * @brief Sets the global control value for reflection.
			...
			/**
			 * @brief Returns the global control value for reflection.
			 * @return float
			 */
			[[nodiscard]]
			float
