/*
 * Emeraude/Graphics/Material/Component/Normal.hpp
...
namespace Emeraude::Graphics::Material::Component
{
	...
	>
	class Normal final : public Interface
	{
		public:
			 ...
			 */
			explicit Normal (const component_t & component, float scale = 1.0F) noexcept
			...
			/**
			 * @brief Returns the normal scale.
			 * @return float
			 */
			[[nodiscard]]
			float
