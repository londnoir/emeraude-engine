/*
 * Emeraude/Graphics/Material/Component/Albedo.hpp
...
namespace Emeraude::Graphics::Material::Component
{
	 ...
	 */
	template< typename component_t, std::enable_if_t< std::is_base_of_v< TypeInterface, component_t >, bool > = false >
	class Albedo final : public Interface
	{
		public:
			 ...
			 */
			explicit Albedo (const component_t & component) noexcept
