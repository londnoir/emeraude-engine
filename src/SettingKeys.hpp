...
namespace EmEn
{
	/* API */
		...
		constexpr auto VkCreateSurfaceWithGLFWKey{"API/Vulkan/CreateSurfaceWithGLFW"};
		constexpr auto DefaultVkCreateSurfaceWithGLFW{true};
	...
	constexpr auto DefaultCoreShowInformation{false};
		...
		constexpr auto DefaultPrintOnlyErrors{false};
		constexpr auto TracerShowLocationKey{"Core/Tracer/ShowLocation"};
		constexpr auto DefaultShowLocation{false};
		constexpr auto TracerShowThreadInfosKey{"Core/Tracer/ShowThreadInfos"};
		constexpr auto DefaultShowThreadInfos{false};
		...
		constexpr auto DefaultLogFormat{"Text"};
