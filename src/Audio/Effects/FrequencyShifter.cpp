/*
 * Emeraude/Audio/Effects/FrequencyShifter.cpp
...
namespace Emeraude::Audio::Effects
{
	...
	FrequencyShifter::setFrequency (float value) noexcept
	{
		...
		{
			Tracer::warning(ClassId, Blob() << "Frequency must be between " << AL_FREQUENCY_SHIFTER_MIN_FREQUENCY << " and " << AL_FREQUENCY_SHIFTER_MAX_FREQUENCY << ".");
