/*
 * Emeraude/Audio/Effects/Flanger.cpp
...
namespace Emeraude::Audio::Effects
{
	...
	Flanger::setPhase (int value) noexcept
	{
		...
		{
			Tracer::warning(ClassId, Blob() << "Phase must be between " << AL_FLANGER_MIN_PHASE << " and " << AL_FLANGER_MAX_PHASE << ".");
	...
	Flanger::setRate (float value) noexcept
	{
		...
		{
			Tracer::warning(ClassId, Blob() << "Rate must be between " << AL_FLANGER_MIN_RATE << " and " << AL_FLANGER_MAX_RATE << ".");
	...
	Flanger::setDepth (float value) noexcept
	{
		...
		{
			Tracer::warning(ClassId, Blob() << "Depth must be between " << AL_FLANGER_MIN_DEPTH << " and " << AL_FLANGER_MAX_DEPTH << ".");
	...
	Flanger::setFeedBack (float value) noexcept
	{
		...
		{
			Tracer::warning(ClassId, Blob() << "Feedback must be between " << AL_FLANGER_MIN_FEEDBACK << " and " << AL_FLANGER_MAX_FEEDBACK << ".");
	...
	Flanger::setDelay (float value) noexcept
	{
		...
		{
			Tracer::warning(ClassId, Blob() << "Delay must be between " << AL_FLANGER_MIN_DELAY << " and " << AL_FLANGER_MAX_DELAY << ".");
