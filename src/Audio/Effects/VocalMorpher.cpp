/*
 * Emeraude/Audio/Effects/VocalMorpher.cpp
...
namespace Emeraude::Audio::Effects
{
	...
	VocalMorpher::setPhonemeACoarseTuning (int value) noexcept
	{
		...
		{
			Tracer::warning(ClassId, Blob() << "Phoneme A coarse tuning must be between " << AL_VOCAL_MORPHER_MIN_PHONEMEA_COARSE_TUNING << " and " << AL_VOCAL_MORPHER_MAX_PHONEMEA_COARSE_TUNING << ".");
	...
	VocalMorpher::setPhonemeBCoarseTuning (int value) noexcept
	{
		...
		{
			Tracer::warning(ClassId, Blob() << "Phoneme B coarse tuning must be between " << AL_VOCAL_MORPHER_MIN_PHONEMEB_COARSE_TUNING << " and " << AL_VOCAL_MORPHER_MAX_PHONEMEB_COARSE_TUNING << ".");
	...
	VocalMorpher::setRate (float value) noexcept
	{
		...
		{
			Tracer::warning(ClassId, Blob() << "Rate must be between " << AL_VOCAL_MORPHER_MIN_RATE << " and " << AL_VOCAL_MORPHER_MAX_RATE << ".");
