...
namespace Emeraude::Audio
{
	...
	void
	EffectSlot::disable (const AbstractObject * source) const noexcept // NOLINT(readability-convert-member-functions-to-static) Keep consistency with enable() method
	{
	...
	void
	EffectSlot::clearFilter () noexcept
	{
		m_filter.reset();
	}
}
