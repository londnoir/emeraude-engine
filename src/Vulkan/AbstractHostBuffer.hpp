/*
 * Emeraude/Vulkan/AbstractHostBuffer.hpp
...
namespace Emeraude::Vulkan
{
	...
	class AbstractHostBuffer : public Buffer
	{
		public:
			 ...
			 * @return bool
			 */
			virtual bool writeData (const MemoryRegion & memoryRegion) noexcept final;
			 ...
			 * @return bool
			 */
			virtual bool writeData (const std::vector< MemoryRegion > & memoryRegions) noexcept final;
			...
			{
				return this->deviceMemory()->unmapMemory();
			}
