...
namespace Emeraude::Overlay
{
	...
	class FramebufferProperties final
	{
		public:
			 ...
			 * @return void
			 */
			void updateProperties (uint32_t width, uint32_t height, float scaleX, float scaleY) noexcept;
			 ...
			 * @return void
			 */
			void updateProperties (const std::array< uint32_t, 2 > & data, float scaleX, float scaleY) noexcept;
			 ...
			 * @return void
			 */
			void setResolution (const std::array< uint32_t, 2 > & data) noexcept;
			 ...
			 */
			[[nodiscard]]
			const std::array< uint32_t, 2 > & resolution () const noexcept;
			 ...
			 */
			[[nodiscard]]
			float inverseScaleX () const noexcept;
			 ...
			 */
			[[nodiscard]]
			float inverseScaleY () const noexcept;
			 ...
			 */
			[[nodiscard]]
			const std::array< uint32_t, 2 > & scaledResolution () const noexcept;
			...
			{
				const auto width = static_cast< float_t >(m_resolution[0]) * std::abs(widthFactor);
				const auto height = static_cast< float_t >(m_resolution[1]) * std::abs(heightFactor);
