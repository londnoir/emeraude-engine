/*
 * src/Libraries/VertexFactory/TriangleGenerator.hpp
...
namespace Libraries::VertexFactory
{
	...
	class TriangleGenerator final
	{
		public:
			 ...
			 */
			void
			addVertex (const Libraries::Math::Vector< 3, float_t > & vertex) noexcept
			{
			 ...
			 */
			void
			addVertices (const std::vector< Libraries::Math::Vector< 3, float_t > > & vertices) noexcept
			{
		...
		private:
			...
			std::vector< Libraries::Math::Vector< 3, float_t > > m_vertices{};
	};
}
