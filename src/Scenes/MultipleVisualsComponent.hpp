/*
 * Emeraude/Scenes/MultipleVisualsComponent.hpp
...
namespace Emeraude::Scenes
{
	 ...
	 */
	class MultipleVisualsComponent final : public AbstractComponent
	{
		public:
			 ...
			 */
			MultipleVisualsComponent (const std::string & name, const AbstractEntity & parentEntity, const std::shared_ptr< Graphics::Renderable::Interface > & renderable, const std::vector< Libraries::Math::Coordinates< float > > & coordinates) noexcept;
		...
		private:
			...
			std::vector< Libraries::Math::Coordinates< float > > m_coordinates;
	};
}
