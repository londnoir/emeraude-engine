...
namespace EmEn::Libs::Math::Space2D
{
	...
	/** @copydoc EmEn::Libs::Math::Space2D::isIntersecting(const Line< precision_t > &, Triangle< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	static
	bool
	...
	/** @copydoc EmEn::Libs::Math::Space2D::isIntersecting(const Line< precision_t > &, Triangle< precision_t > &, Point< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	static
	bool
