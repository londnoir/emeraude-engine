...
{
	// NOLINTBEGIN(cppcoreguidelines-pro-bounds-constant-array-index, readability-identifier-length, cppcoreguidelines-pro-bounds-pointer-arithmetic, *-magic-numbers)
	...
	// NOLINTEND(cppcoreguidelines-pro-bounds-constant-array-index, readability-identifier-length, cppcoreguidelines-pro-bounds-pointer-arithmetic, *-magic-numbers)
}
