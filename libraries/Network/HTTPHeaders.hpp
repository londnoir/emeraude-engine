/*
 * Libraries/Network/HTTPHeaders.hpp
...
namespace Libraries::Network
{
	...
	class HTTPHeaders
	{
		public:
			 ...
			 * @return void
			 */
			virtual void setVersion (Version version) noexcept final;
			 ...
			 */
			[[nodiscard]]
			virtual Version version () const noexcept final;
			 ...
			 * @return void
			 */
			virtual void add (const std::string & key, const std::string & value) noexcept final;
			 ...
			 */
			[[nodiscard]]
			virtual std::string value (const std::string & key) const noexcept final;
			 ...
			 */
			[[nodiscard]]
			virtual bool parse (const std::string & rawHeaders) noexcept final;

			/**
			 * @brief Returns whether the headers is valid.
			 * @return bool
			 */
			[[nodiscard]]
